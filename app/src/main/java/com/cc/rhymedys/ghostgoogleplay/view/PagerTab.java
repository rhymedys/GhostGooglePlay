...
import com.cc.rhymedys.ghostgoogleplay.activity.BaseActivity ;
...
public class PagerTab extends ViewGroup {
	...
	private int mTabTextSize = 30; //tab文字大小
	...
	private void init() {
		//把一个值从dip转换成px
		mIndicatorHeight = UIUtils.dip2pix(mIndicatorHeight);
		mDividerPadding = UIUtils.dip2pix(mDividerPadding);
		mTabPadding = UIUtils.dip2pix(mTabPadding);
		mDividerWidth = UIUtils.dip2pix(mDividerWidth);
		mTabTextSize = UIUtils.dip2pix(mTabTextSize);
		//创建一个scroller
